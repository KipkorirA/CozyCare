// Importing React and the necessary CSS file for styling
// import React from 'react';
import './styles/PrivacyAndCookiePolicyPage.css'; // Assuming you've got CSS styles for this component
...
const PrivacyAndCookiePolicyPage = () => {
    return (
        <div className="privacy-policy">
            ...
            <h2>Health Data and Guidelines</h2>
            <p>
            ...
            <p>
                ...
                <a href="mailto:support@cozycare.com"> support@cozycare.com</a>
            </p>
        </div>
    );
};
